package baco.conta.contasalario;
import baco.conta.Conta;
import baco.interfaces.EmprestimoHabilitado;

public class ContaSalario extends Conta implements EmprestimoHabilitado {
    public ContaSalario(int agencia, int numero, double saldo, double limite, double investimento, String nome, String sobrenome, String telefone, int type) {
        super(agencia, numero, saldo, limite, investimento, nome, sobrenome, telefone, type, type==4);
        this.setEmprestimo(type==4);
    }
