package baco.conta.contapoupanca;
import baco.conta.Conta;
import baco.interfaces.EmprestimoHabilitado;

public class ContaPoupanca extends Conta implements EmprestimoHabilitado {
    public ContaPoupanca(int agencia, int numero, double saldo, double limite, double investimento, String nome, String sobrenome, String telefone, int type) {
        super(agencia, numero, saldo, limite, investimento, nome, sobrenome, telefone, type, type==2);
